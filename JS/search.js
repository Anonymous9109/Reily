...
function arabicToEnglish(str) {
  const map = {
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§":"a","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£":"a","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¥":"e","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢":"aa",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¨":"b","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂª":"t","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ«":"th","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬":"j","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­":"h","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ®":"kh",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯":"d","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°":"th","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±":"r","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ²":"z","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³":"s","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ´":"sh",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂµ":"s","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶":"d","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ·":"t","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¸":"th","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¹":"a","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº":"gh",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"f","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"q","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"k","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"l","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"m","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"n",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"h","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"w","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"y",
    "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©":"h","ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ":"a"
  };
...
function searchMovies() {
  ...
  const searchTerm = arabicToEnglish(rawInput); // Arabic ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ English matching
